        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <div class="btn-group" style="padding: 10px;">
              ...
              <a class="btn btn-primary" onclick="window.open('search_m_sub_category.php?IDF=Master', 'mywin', 'width=800, height=700');" class="btn btn-info btn-sm">Search</a>
...
<script src="js/m_sub_category.js"></script>
<!-- <script>getdt();</script> -->
